...
roi_nb, roi_hierarchy_nb= pcv.roi.rectangle(img=color_corrected_img, x=480, y=650, h=700, w=1500)
...
#define an ROI
roi_abnb, roi_hierarchy_abnb= pcv.roi.rectangle(img=color_corrected_img, x=480, y=650, h=700, w=1500)
...
if obj_area_abnb > 0:
    ...
    boundary_image = pcv.analyze_bound_horizontal(img=color_corrected_img, obj=obj_combined_abnb, mask=mask_final_combo_abnb, 
                                               line_position=1355, label="default")
